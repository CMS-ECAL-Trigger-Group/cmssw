#ifndef FECONFIGODDWEIGHT_H
#define FECONFIGODDWEIGHT_H
...
class FEConfigOddWeightInfo : public IODConfig {
public:
  ...
  inline std::string getTable() override { return "FE_CONFIG_WEIGHT2_INFO"; }
  ...
  // operators
  inline bool operator==(const FEConfigOddWeightInfo& r) const { return (m_ID == r.m_ID); }
  inline bool operator!=(const FEConfigOddWeightInfo& r) const { return !(*this == r); }
